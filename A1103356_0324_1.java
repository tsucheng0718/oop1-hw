...
public class A1103356_0324_1 {
    public static void main(String[] args) {
        ...
        for (int i = 0 ; i < animals.length ; i++) {
            System.out.println(animals[i].name + "距離計算");
            System.out.print("enter x(時間):");
            int num1 = input.nextInt();
            System.out.print("enter y or not (o/x):");
            String a = input.next();
            if (a.equals("o")){
                System.out.print("enter y(加速度):");
                double num2 = input.nextFloat();
                if (num2 == 0) {
                    System.out.println(animals[i].name + "距離為" + animals[i].distance(num1));
                } else {
                    System.out.println(animals[i].name + "距離為" + animals[i].distance(num1, num2));
                }
